...
$_lang['msimportexport_resource_import_service_setting_parent_default_help'] = 'Укажите документ который будет родительским если в файле импорта не был передан родитель  (параметр parent) или если он не был найден';
...
$_lang['msimportexport_resource_import_service_setting_create_unique_alias_help'] = 'Если включена опция "Проверять алиас на уникальность" и возникает дублирование, то произойдет автоматическое создание уникального алиаса. Включение данной опции деактивирует возникновения события msieOnImportNotUnique.';
...
$_lang['msimportexport_resource_import_service_setting_parent_delimiter_help'] = 'Укажите символ разделитель для поля parent который задан в виде цепочки из названий родителей. Если параметр не зада то будет использоваться значение из опции "Первый разделитель данных" ';
