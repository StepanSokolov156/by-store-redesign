...
// cd /home/modxstore/web/dev.modxstore.net/public_html/core/components/ieyandexmarket/ && composer dump-autoload
/**
 * MODx IeYandexMarket Class
 *
 * @package msimportexport
 */
class IeYandexMarket
{
    const version = '1.0.0';
    /** @var modX $modx */
    public $modx;
    ...
    public $config = array();
    /** @var string */
    public $namespace = 'ieyandexmarket';
     ...
     * @return IeYandexMarket
     */
    function __construct(modX &$modx, array $config = array())
    {
        $this->modx =& $modx;
        $corePath = $this->modx->getOption('ieyandexmarket.core_path', $config, $this->modx->getOption('core_path', null, MODX_CORE_PATH) . 'components/ieyandexmarket/');
        $assetsUrl = $this->modx->getOption('ieyandexmarket.assets_url', $config, $this->modx->getOption('assets_url') . 'components/ieyandexmarket/');
        $assetsPath = $this->modx->getOption('ieyandexmarket.assets_path', $config, $this->modx->getOption('assets_path', null, MODX_ASSETS_PATH) . 'components/ieyandexmarket/');
        ...
        $this->config = array_merge(array(
            ...
            'toolsHandler' => $this->modx->getOption('ieyandexmarket_tools_handler_class', null, 'IeYandexMarketTools'),
        ), $config);

        $this->modx->lexicon->load('ieyandexmarket:default');
        $this->modx->addPackage('ieyandexmarket', $this->config['modelPath']);
    ...
    public function runProcessor($action = '', $data = array())
    {
        ...
        $processorsPath = !empty($this->config['processorsPath'])
            ...
            : MODX_CORE_PATH . 'components/ieyandexmarket/processors/';
