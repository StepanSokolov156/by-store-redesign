...
// cd /home/modxstore/web/dev.modxstore.net/public_html/core/components/iegallery/ && composer dump-autoload
/**
 * MODx IeGallery Class
 *
...
class IeGallery
{
    ...
    {
        $this->modx =& $modx;
        $corePath = $this->modx->getOption('iegallery.core_path', $config, $this->modx->getOption('core_path', null, MODX_CORE_PATH) . 'components/iegallery/');
        $assetsUrl = $this->modx->getOption('iegallery.assets_url', $config, $this->modx->getOption('assets_url') . 'components/iegallery/');
        $assetsPath = $this->modx->getOption('iegallery.assets_path', $config, $this->modx->getOption('assets_path', null, MODX_ASSETS_PATH) . 'components/iegallery/');
        ...
        $this->config = array_merge(array(
            ...
            'toolsHandler' => $this->modx->getOption('iegallery_tools_handler_class', null, 'IeGalleryTools'),
        ), $config);

        $this->modx->lexicon->load('iegallery:default');
        $this->modx->addPackage('iegallery', $this->config['modelPath']);
    ...
    public function runProcessor($action = '', $data = array())
    {
        ...
        $processorsPath = !empty($this->config['processorsPath'])
            ...
            : MODX_CORE_PATH . 'components/iegallery/processors/';
